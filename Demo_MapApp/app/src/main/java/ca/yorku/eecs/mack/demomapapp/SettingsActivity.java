...
public class SettingsActivity extends Activity implements OnSharedPreferenceChangeListener
{
	 ...
	 * The approach in this demo to deal with the changes to settings in the main application
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key)
	{
		...
		if (key.equals(SATELLITE_KEY))
		{
			//Log.i(MYDEBUG, "SATELLITE setting changed: New value=" + sharedPreferences.getBoolean(key, false));			
		} 
	}
